...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <Helmet>
        <title>Iniciar Sesión | KORZEŃ - Pracownia</title>
      </Helmet>
            ...
            <div className="relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  Zaloguj się, aby kontynuować zakupy i śledzić swoje zamówienia w naszej pracowni rękodzieła.
                </p>
                <div className="space-y-4 text-sm text-gray-600">
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-korzen-olive rounded-full mt-2"></div>
                    <p>Szybsze finalizowanie zakupów</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-korzen-olive rounded-full mt-2"></div>
                    <p>Personalizowane rekomendacje produktów</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <a href="#" className="text-xs text-korzen-olive hover:text-korzen-charcoal transition-colors">
                      Zapomniałeś hasła?
                    </a>
                  </div>
                  <div className="relative">
                ...
                <div className="flex items-center space-x-2">
                  <input 
                    type="checkbox" 
                    id="remember"
                    className="w-4 h-4 text-korzen-olive border-gray-300 rounded focus:ring-korzen-olive"
                  />
